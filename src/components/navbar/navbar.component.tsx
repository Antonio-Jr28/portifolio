...
export const Navbar = () => {
  ...
  return (
    <div className="anime flex flex-col items-center justify-around p-4 h-24 w-auto shadow-xl md:flex-row md:justify-around md:items-center md:px-32 md:h-20 ">
